...
import example.chedifier.chedifier.accessibility.VirtualDescendantsProvider;
...
//        }
    ...
    private example.chedifier.chedifier.accessibility.AccessibilityDelegate mAccessbilityDelegate
            = new example.chedifier.chedifier.accessibility.AccessibilityDelegate(this,true);
    ...
    @Override
    public example.chedifier.chedifier.accessibility.AccessibilityDelegate getAccessibilityDelegator() {
