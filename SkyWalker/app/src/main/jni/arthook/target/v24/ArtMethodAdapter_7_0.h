...
#ifndef HOOK_ARTMETHODADAPTER_7_0_H
#define HOOK_ARTMETHODADAPTER_7_0_H

#include <jni.h>
#include <stdint.h>
#include "ArtMethod_7_0.h"

class ArtMethodAdapter_7_0: public IArtMethodAdapter {
    ...
    public:
        ...
        ArtMethodAdapter_7_0(jmethodID methodID){
            mMethod = reinterpret_cast<ArtMethod_7_0*>(methodID);
        }
    ...
    private:
        ...
        ArtMethod_7_0* mMethod;

};



#endif //HOOK_ARTMETHODADAPTER_7_0_H
