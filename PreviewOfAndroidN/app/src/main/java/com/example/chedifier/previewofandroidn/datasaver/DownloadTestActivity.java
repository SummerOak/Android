 ...
 */
public class DownloadTestActivity extends BaseActivity implements View.OnClickListener,IDownloadMgrListener{
...
//        startActivity(intent);
    ...
    private void checkSdcardPermission(){
        ...
        MyPermissionManager.checkSdcardPermission(this,Manifest.permission.WRITE_EXTERNAL_STORAGE);
    }
    ...
    private class MyBaseAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if(view == null){
                view = View.inflate(DownloadTestActivity.this,R.layout.download_listitem,null);
